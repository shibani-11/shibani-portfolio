...
const Accomplishments = () => {
  const accomplishments = [
    {
      title: "Apex: Delivery and Profitability Award",
      organization: "Accenture Service Private Limited, India",
    },
    {
  ...
  return (
    <section id="accomplishments" className="py-24 px-6 md:px-12 lg:px-24 bg-[#0A0F1C] relative">
      <ParticlesBackground />
